...
export const metadata: Metadata = {
  title: "Grand Vista Hotel - Luxury Downtown Accommodations",
  description: "Experience 5-star luxury at Grand Vista Hotel with elegant rooms, world-class amenities, spa services, and exceptional hospitality in the heart of the city.",
  keywords: "luxury hotel, downtown accommodation, 5-star hotel, spa hotel, business hotel, city view rooms, fine dining restaurant",
  openGraph: {
    title: "Grand Vista Hotel - Luxury Downtown Accommodations",
    description: "Experience 5-star luxury with elegant rooms, world-class amenities, and exceptional service",
